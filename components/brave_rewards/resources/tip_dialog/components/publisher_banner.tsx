...
function getBackgroundType (publisherInfo: PublisherInfo) {
...
export function PublisherBanner () {
  ...
  return (
    <style.root
      data-background-type={getBackgroundType(publisherInfo)}
      ...
      <style.card>
        <style.header>
          <style.logo>
            ...
            <style.verifiedIcon data-verified={verifiedType}>
